...
class LaravelMySQLReuseJournal implements ReuseJournalInterface
{
     ...
     * @return void
     */
    private function recordJournalingStop()
    {
     ...
     * @return void
     */
    private function createChangeTrackerTable()
    {
     ...
     */
    private function setUpJournalTablesAndTriggers()
    {
     ...
     */
    private function createJournalTable(string $srcTable)
    {
        try {
     ...
     */
    private function createTableTriggers(string $srcTable)
    {
     ...
     */
    private function createTrigger(string $srcTable, string $triggerType, array $fields, string $copyFrom)
    {
        try {
            $journalTable = $this->generateJournalTableName($srcTable);
     ...
     * @return void
     */
    private function resetChangeTrackerTable()
    {
     ...
     */
    private function undoTableChanges(string $table)
    {
        try {
     ...
     */
    private function applyUndoTableChanges(string $table)
    {
     ...
     * @return void
     */
    private function journalInsertRow(string $table, array $values)
    {
     ...
     * @return void
     */
    private function journalUpdateRow(string $table, array $values, array $primaryKey)
    {
     ...
     * @return void
     */
    private function journalDeleteRow(string $table, array $values, array $primaryKey)
    {
