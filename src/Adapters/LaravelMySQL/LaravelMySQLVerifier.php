...
class LaravelMySQLVerifier implements VerifierInterface
{
     ...
     * @return void
     */
    public function setUpVerification($createStructureHash, $createDataHash)
    {
     ...
     * @return void
     */
    private function populateVerificationTable(bool $createStructureHash, bool $createDataHash)
    {
