...
abstract class AbstractReuseMetaDataTable implements ReuseMetaDataTableInterface
{
    ...
    private ?string $cantReuseReason = null;
     ...
     * @return string
     */
    private function renderComparison(?string $value1, ?string $value2): string
    {
     ...
     * @return string
     */
    private function renderDbValue(?string $value): string
    {
