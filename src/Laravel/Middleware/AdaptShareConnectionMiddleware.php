...
class AdaptShareConnectionMiddleware
{
     ...
     * @return void
     */
    private function reassignConnectionDatabases(Request $request)
    {
     ...
     * @return mixed[]|null
     */
    private function pickConnectionDBsFromRequest(Request $request)
    {
     ...
     * @return void
     */
    private function prepareConfig(array $connectionDatabases)
    {
