...
abstract class AbstractLaravelPDO
{
     ...
     * @return void
     */
    public function createDatabase($createQuery)
    {
     ...
     */
    public function dropDatabase($dropQuery, $databaseName)
    {
        try {
     ...
     * @return string[]
     */
    protected function performListDatabases($query, $field): array
    {
        try {
