...
class LaravelPropBagDTO extends PropBagDTO
{
     ...
     * @return mixed
     */
    public function adaptConfig(string $configKey, ?string $propName = null, mixed $default = null)
    {
        return $this->prop(
            $propName,
     ...
     * @return mixed
     */
    public function config(string $configKey, ?string $propName = null, mixed $default = null)
    {
        return $this->prop(
            $propName,
