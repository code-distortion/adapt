...
class AdaptVerificationException extends AdaptException
{
     ...
     * @return self
     */
    public static function tableWasCreated(string $database, string $table): self
    {
     ...
     * @return self
     */
    public static function tableWasRemoved(string $database, string $table): self
    {
     ...
     * @return self
     */
    public static function tableStructureHasChanged(string $database, string $table): self
    {
     ...
     * @return self
     */
    public static function tableContentHasChanged(string $database, string $table): self
    {
