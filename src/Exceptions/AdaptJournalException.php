...
class AdaptJournalException extends AdaptException
{
     ...
     * @return self
     */
    public static function cannotReplaceCreateQueryKeys(string $table): self
    {
        return new self(
     ...
     * @return self
     */
    public static function cannotAlterCreateQueryTableName(string $table): self
    {
        return new self(
            "The journal table for table \"$table\" could not be created. "
     ...
     * @return self
     */
    public static function journalCreateTableQueryFailed(string $table, ?Throwable $previousException = null): self
    {
     ...
     * @return self
     */
    public static function cannotCreateJournalTable(string $table, ?Throwable $previousException = null): self
    {
     ...
     * @return self
     */
    public static function tableHasNoPrimaryKey(string $table): self
    {
