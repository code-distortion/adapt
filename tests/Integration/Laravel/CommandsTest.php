        ...
        return [
            [
                ...
                'expectedOutputWithTestingConn' =>
                    ...
                    . "  - [file1]",
                'substitutions' => [
                    '[file1]' => '[adapt-test-storage]/test-database.2881d7-0161442c4a3a.sqlite',
                ],
            ],
            [
                'config' => $this->newConfigDTO('sqlite')
            ...
            [
                ...
                'substitutions' => [
                    '[file1]' => '[adapt-test-storage]/test-database.2881d7-0161442c4a3a.sqlite',
                    '[file2]' => '[adapt-test-storage]/snapshot.database.2881d7-0320bdd00911.sqlite',
                ],
            ],
            [
                'config' => $this->newConfigDTO('sqlite')
                ...
                'substitutions' => [
                    '[file1]' => '[adapt-test-storage]/test-database.2881d7-0161442c4a3a.sqlite',
                    '[file2]' => '[adapt-test-storage]/snapshot.database.2881d7-059d0b188354.sqlite',
                ],
            ],
            [
                'config' => $this->newConfigDTO('sqlite')
                ...
                'substitutions' => [
                    '[file1]' => '[adapt-test-storage]/test-database.2881d7-0161442c4a3a.sqlite',
                    '[file2]' => '[adapt-test-storage]/snapshot.database.2881d7-0320bdd00911.sqlite',
                    '[file3]' => '[adapt-test-storage]/snapshot.database.2881d7-059d0b188354.sqlite',
                ],
            ],
        ];
    }
